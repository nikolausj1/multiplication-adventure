---
title: "Math Tutor - Project Instructions"
created: 2026-07-24
modified: 2026-07-24
version: 1.1
...
Parent standards and the Oracle system are defined in `_Projects/CLAUDE.md` (inherited; read it). Key project docs: `Level Up Math - PRD.md` is the source of truth for scope and decisions.
